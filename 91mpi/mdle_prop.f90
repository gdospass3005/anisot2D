...
CONTAINS
  ...
  SUBROUTINE prop_anisot_2D(Vx,Vz,Sxx,Sxz,Szz,&
       C11,C13,C33,C44,rhox,rhoz,dx,dt,Nxm,Nx,Nzm,Nz)
    IMPLICIT NONE
    INTEGER, INTENT(IN) :: Nxm,Nx,Nzm,Nz
    REAL, DIMENSION(Nxm:Nx,Nzm:Nz), INTENT(INOUT) :: Vx,Vz,Sxx,Sxz,Szz
    REAL, DIMENSION(Nxm:Nx,Nzm:Nz), INTENT(IN)    :: C11,C13,C33,C44
    REAL, DIMENSION(Nxm:Nx,Nzm:Nz), INTENT(IN)    :: rhox,rhoz
