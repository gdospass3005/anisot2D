...
SUBROUTINE bt_apply_left(pp,Nx,Nzm,Nz,nb,taper)
IMPLICIT NONE
  INTEGER :: Nx,Nzm,Nz,nb
  REAL, DIMENSION(nb) :: taper
  REAL, DIMENSION(1:nb,Nzm:Nz) :: pp
  INTEGER :: i
...
SUBROUTINE bt_apply_right(pp,Nx,Nzm,Nz,nb,taper)
IMPLICIT NONE
  INTEGER :: Nx,Nzm,Nz,nb
  REAL, DIMENSION(nb) :: taper
  REAL, DIMENSION(Nx-nb+1:Nx,Nzm:Nz) :: pp
  INTEGER :: i
...
SUBROUTINE bt_apply_top(pp,Nx,nb,taper)
IMPLICIT NONE
  INTEGER :: Nx,nb
  REAL, DIMENSION(nb) :: taper
  REAL, DIMENSION(Nx,nb) :: pp
  INTEGER :: i
...
IMPLICIT NONE
  INTEGER :: Nx,Nz,nb
  REAL, DIMENSION(nb) :: taper
  REAL, DIMENSION(Nx,Nz-nb+1:Nz) :: pp
  INTEGER :: i
